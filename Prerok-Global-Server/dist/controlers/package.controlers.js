...
exports.calculateCost = async (req, res) => {
    try {
        ...
        const totalDistance = calculateDistance(country1Info.coordinates.lat, country1Info.coordinates.lon, country2Info.coordinates.lat, country2Info.coordinates.lon);
