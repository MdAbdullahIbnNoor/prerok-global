...
const BannerCustoms = () => {
    return (
        <div className="hero min-h-72 md:min-h-[700px]" style={{ backgroundImage: `url(${bannerImg})` }}>
            <div className="hero-overlay w-full bg-opacity-75 lg:bg-opacity-30"></div>
            <div className="text-center">
                <div className="flex flex-1 gap-10 wrapper">
                    <div className="w-full lg:w-[1400px] lg:bg-cyan-500 px-10 lg:pr-44 lg:pl-20 lg:py-8 text-left rounded-r-2xl ">
