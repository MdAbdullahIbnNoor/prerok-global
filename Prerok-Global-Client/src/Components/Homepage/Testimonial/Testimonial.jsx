                ...
                <div className="md:flex-col md:items-center md:justify-center">
                  <div>
                    <img
                      alt="Taylor"
                      loading="lazy"
                      className="mx-auto h-20 w-3h-20 rounded-full border-4 border-amber-500 mb-2"
                  ...
                  <div className="max-w-3xl mx-auto text-center text-lg text-gray-100">
                    <p>
                      Swift, reliable, and stress-free! My go-to for seamless
                      deliveries. Exceptional service that exceeds expectations
                ...
                <div className="md:flex-col md:items-center md:justify-center">
                  ...
                  <div className="max-w-3xl mx-auto text-center text-lg text-gray-100">
                    <p>
                      ...
                      stress-free, they redefine efficiency. Seamless deliveries
                      that exceed expectations every time. From prompt arrivals
                      to secure handling, their service ensures peace of mind.
                      Highly recommended for a superior and dependable shipping
                      experience.
                    </p>
                  </div>
                </div>
