...
const Pricing = () => {
    ...
    return (
     ...
     data-aos-duration="1000">
            ...
            <div className='md:flex gap-4 lg:max-w-screen-2xl mx-auto justify-center' data-aos="fade-up"
     data-aos-duration="2000">
                {pricingPlans.map((plan) => (
                    <div
                        key={plan.id}
                        className={`flex-col space-y-3 px-4 border-2 box ${plan.id === 2 ? 'border-amber-500' : 'border-gray-200'} hover:border-amber-500 py-10 items-center justify-center w-1/4 ${hoveredPlan === plan.id ? 'hovered' : ''} ${plan.id === 2 ? 'bg-amber-500' : ''}`}
