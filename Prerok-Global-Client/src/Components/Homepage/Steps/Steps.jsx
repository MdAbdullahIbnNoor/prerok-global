...
const Steps = () => {
  return (
    <div
      className="h-full overflow-hidden lg:h-72 relative"
      style={{ backgroundImage: `url(${cityImg})`, backgroundSize: "cover" }}
    >
      <div className="pt-8 lg:pt-0 relative bg-black/70 flex flex-col lg:flex-row justify-between items-center ">
        ...
        <div
          className="relative right-6 flex justify-around text-white"
          data-aos="fade-left"
        >
          <div className="flex justify-between items-center">
        ...
        <div data-aos="fade-left">
          <img
            src={deliveryTruck}
            alt=""
            className="md:mt-16 relative left-10 lg:left-0"
          />
        </div>
      </div>
    </div>
