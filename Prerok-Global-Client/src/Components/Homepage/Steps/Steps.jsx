...
const Steps = () => {
  return (
    <div className="h-full overflow-hidden lg:h-72 bg-[url('../../../../public/images/city.jpg')]">
      <div className="pt-8 lg:pt-0 relative bg-black/70 flex flex-col lg:flex-row justify-between items-center ">
        ...
        <div className="relative right-6 flex justify-around text-white" data-aos="fade-left">
