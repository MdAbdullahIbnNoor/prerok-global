...
const Steps = () => {
  return (
    <div className="h-72 border bg-[url('../../../../public/images/city.jpg')] bg-opacity-25 flex justify-between items-center ">
      <div className="flex justify-around text-white px-12">
        <div className="flex justify-between items-center">
          ...
          <div className=" ml-3">
            ...
            <p className="w-3/4 mt-2 text-[#98968c] text-sm">
      ...
      <div>
        <img src={deliveryTruck} alt="" className="mt-16" />
      </div>
    </div>
  );
};
