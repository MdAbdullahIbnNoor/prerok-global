...
const PDFGenerator = ({ bookingInfo }) => {
    ...
    const handleDownload = () => {
        ...
        // pdf heading
        pdf.setFontSize(15);
        pdf.text("Thank you for choosing PrerokGlobal", pdf.internal.pageSize.width / 2, 10, { align: 'center' });
        pdf.setFontSize(10);
        pdf.text(`TrackingID: ${bookingInfo?.trackingID}`, pdf.internal.pageSize.width / 2, 15, { align: 'center' });
