            ...
            <div className="border-t border-l border-r border-[#f5ab35] w-full lg:w-4/12 mx-auto mt-24 pt-8 shadow-xl">
                ...
                <div className="mt-6">
                    <form onSubmit={handleLogin} className="w-11/12 mx-auto">
                        {/* email  */}
                        <input type="email" name="email" className="border h-11 w-full px-4 py-2 rounded-sm caret-[#f5ab35] focus:border-[#f5ab35]" placeholder="YOUR EMAIL" id="" /> <br />
                        {/* password  */}
                        ...
                        <input type="submit" className="border h-11 w-full px-5 py-2 mt-3 bg-[#f5ab35] text-white font-bold rounded-sm hover:cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#222222]" value="SIGN IN NOW" />
                    </form>
